/// abs Repo
export 'use_cases/usecases/times_usecase.dart';
...
export 'adapters/favorite_character_adapter/favorite_character_adapter.dart';
export 'adapters/favorite_image_adapter/favorite_image_adapter.dart';
export 'adapters/register_adapter.dart';

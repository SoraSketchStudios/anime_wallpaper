...
class ImageCharacterBloc extends Bloc<ImageCharacterEvent, ImageCharacterState> {
  ...
  ImageCharacterBloc(this.characterRepo, this.imageUseCase)
      : super(const ImageCharacterLoading(null, null)) {
    ...
    //   List<ImageModel>? imageCharacterModels = await characterRepo
    ...
    on<OnClickSetHomeScreen>((event, emit) {
      ...
      imageUseCase.setWallpaper(event.imageCharacterModel.id ?? "");
